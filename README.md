-   [Testing PIC18F46K42 XPRESS
    ...
    -   [Testing RTC with Xpress Board](#testing-rtc-with-xpress-board)
...
The program sends a timestamp after the initial header on startup. The
...
-   A ‘\\t’ clears the LCD.
-   A **Ctrl + t** causes the time to be displayed in the LCD and both
    time and date to be displayed in PuTTY.
-   A **Ctrl + d** causes the date to be displayed in the LCD and both
    time and date to be displayed in PuTTY.
