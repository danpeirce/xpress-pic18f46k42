...
If the sensor readings are added together one can see when the robot encounters more than a single line. This might be used to determine when to 
stop the proportional differential algorithm and employ a different strategy.
